...
<head>
    ...
    <title>Quotation Verification {{ $row['number'] }}</title>
        ...
        <div class="content">
            <div class="grid">
                <div class="panel">
                    ...
                    <div class="row"><span>Type</span><strong>Quotation</strong></div>
                    ...
                    <div class="row"><span>Issue Date</span><strong>{{ $quotation['quotation_date'] }}</strong></div>
                    <div class="row"><span>Valid Until</span><strong>{{ $quotation['expiry_date'] }}</strong></div>
                    <div class="row"><span>Customer</span><strong>{{ $quotation['customer_name'] }}</strong></div>
                    <div class="row"><span>Total</span><strong>{{ $quotation['currency'] }} {{ number_format($quotation['grand_total'], 0) }}</strong></div>
                </div>
            ...
            <div class="notice">
                ...
                This QR scan confirms the quotation details and ownership match Terex Innovation Lab records. If any detail looks suspicious, contact the issuer immediately.
            </div>
        </div>
    </div>
</div>
